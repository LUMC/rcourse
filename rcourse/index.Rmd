...
The course is divided in half-day sessions. Each session is split into a few small topics and each topic is introduced as follows:
...
### The last session: self study assignment

A **self study assignment** (SSA) will be offered during the last session. 
A set of tasks will be provided to be solved individually without and help from others. 
At the end there will be a general discussion.
