...
- **Ramin Monajemi (correspondence rmonajemi@lumc.nl)**
...
- Use R to create plots (with [`tidyverse/ggplot2`](https://ggplot2.tidyverse.org/)).
...
Please check the date and the location on the [LUMC Onderwijsrooster](https://rooster.universiteitleiden.nl/schedule) and bring **your own laptop**.
