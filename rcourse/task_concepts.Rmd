...
## Reading a table from a .csv file, compare base-R `read.tsv` with tidyverse `read_tsv`. {#topic:ReadCsvBaseTidyverse} {#needs:ExDataFrameColumns} {#library:tidyverse} {#function:read.csv} {#function:read_tsv} {#function:class} {#function:str} {#function:head}
...
Observe the small differences in output of `str`, `head` and `class` functions applied to both tables.
...
Thu September 26 (13:00-17:30)
        ...
        - basic statistics:
                ...
                - lm()
                - median(), cut(), table() for 2x2 table
                - chiq.test()
                - epitools::oddsratio()
