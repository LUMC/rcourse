...
In the examples above we added a new variable to our dataset, but you can also update an existing a variable. For example, let's say we want to have the age expressed (roughly) in days instead of years: 
