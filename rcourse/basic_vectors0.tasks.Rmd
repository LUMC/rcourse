...
Try them to show the first 5 and the last 7 elements of a randomly generated vector `v <- rnorm( 20 )`.
```{r}
v <- rnorm( 20 )
v
head( v, 5 )
...
5. *Type conversion to a character vector*.  
...
6. *Type conversion to a numerical vector*.  
