...
`fct_count` is a `tidyverse`/`forcats` method of counting factor elements and produces a result as a table (`tibble` object).  
An base-R version of counting elements is provided by `table()` function.  
