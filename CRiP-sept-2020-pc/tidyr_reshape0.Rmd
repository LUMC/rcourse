...
```{r, echo=FALSE, results='asis'}
msg <- "Yes, for example smokes and alcohol, both are categorical with values {yes,no}. You may 'gather' these variables into drug_habit= {smokes,alcohol} and drug_use={yes,no}."
qa(msg)
```
