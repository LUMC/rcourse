...
For the following parts of the course you need the files: `pulse.csv` and `survey.csv` (look at the `Data` in the course materials).  
...
Type the following command in the `Console` and execute it to check whether you can access the `pulse.csv` file.  
