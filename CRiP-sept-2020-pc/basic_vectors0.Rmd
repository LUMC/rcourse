...
v <- ( x > 2 )  # Here we explicitely catch this logical vector to variable v
v
```
...
When a missing value appears in an expression, the result is usually also a missing value:
