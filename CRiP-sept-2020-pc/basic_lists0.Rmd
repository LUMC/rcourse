...
A [list](http://cran.r-project.org/doc/manuals/r-release/R-lang.html#List-objects) can be thought of as zero or more data elements (of _any type_), kept in order.  
The elements can be accessed by their position (first element, second element, ... ).  
Typically the elements are also named and consequently can be also accessed by names.
...
## Length and elements of a list by position
...
## Names and elements of list by name
