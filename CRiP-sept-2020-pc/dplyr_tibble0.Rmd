...
As you can see a tibble is in its core a base R `data.frame` with some additional behaviour 
enforced by `tbl_df` and `tbl` types. In this course we will be working mainly with tibbles 
rather than base R data.frame. However, for those of you interested in the differences between 
tibble and data.frame please see [tibble vs data.frame*](dplyr_tibble1.html).

## Inspect your data

To find out the dimmensions of the tibble as values:
...
or top and bottom parts of the tibble: 
