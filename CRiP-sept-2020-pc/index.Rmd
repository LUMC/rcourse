...
- R expressions
- Data objects (vectors , data frames, lists)
...
- Data manipulation : filtering, sorting, summarising of a table; joining/merging multiple tables (with [dplyr](https://cran.r-project.org/web/packages/dplyr/README.html) and [tidyr](https://github.com/hadley/tidyr)) [[cheat sheet](http://www.rstudio.com/wp-content/uploads/2015/02/data-wrangling-cheatsheet.pdf)]
- Visualisation: histograms, scatter plots, boxplots (in pure R and with [ggplot2](http://ggplot2.org/)) [[cheat sheet](http://www.rstudio.com/wp-content/uploads/2015/12/ggplot2-cheatsheet-2.0.pdf)]
...
- **download the course** [.zip file](`r params$RCourseURL`/R_course.zip) to your laptop. Unpack the zip file to a directory, and please check whether you can open `index.html` file from the directory.
...
```
The course will be covered in 3,5 days : 

Monday    21-09-2020 13:15-17:00  : Introduction, Calculator, Variables, Basic Vectors, 
                                    RStudio projects, Scripts/R Markdown   
Tuesday   22-09-2020 09:00-17:00  
                     09:00-10:00  : R Markdown & RStudio (Q&A)  (SzK)
                                    
                      10:00-12:00 : introduction tidyverse
                                  : tibble : show how to read the pulse dataset
                                      RM : add top_n to extra exercises
                                  : select, filter (conditionals), mutate 
                                  : 1h off
                     13:00-17:00  : pipe operator, summarise : 20min
                                    1h students work on exercises
                                    10min do sample exercise
                                    group, arrange?, queries : 20min
                                    
                                    
Wednesday 23-09-2020 09:00-17:00
                     09:00-12:00  : queries, join, reshape
                     13:00-17:00  : ggplot: scatter,boxplot, facet, 
Thursday  22-09-2020 09:00-17:00  : lists with t.test example, formula with lm example  , 
                                  descriptives 
```
