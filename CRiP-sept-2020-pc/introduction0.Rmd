...
The goal of the course is to teach students how _R_ language can be used to build quickly a report with very simple statistical analysis of data provided in a table.  
Therefore, instead of using base _R_ functionality only, we use an extended version provided by the [_tidyverse_](https://www.tidyverse.org) package.
