...
The project organizes a huge community of users and package developers:
...
_RStudio_ from https://rstudio.com/ is an open source integrated development environment (initially developed) for programming in _R_ language.

It provides useful features to help in developement of the R code and in organization of projects.

RStudio is not necessary to work with R programs, but it is highly recommended (and it is used in this course).
...
To pass the exam the students are requested to build a script producing a report with the following parts:
