...
ggplot( pulse, aes( x = weight, y = height ) ) +
  geom_point( aes( color = exercise, shape = gender ), size = 3, alpha = 0.8 ) +
...
ggplot( pulse, aes( x = weight, y = height ) ) +
  geom_point( aes( color = exercise, shape = gender ), size = 3, alpha = 0.8 ) +
  scale_y_continuous( name = "Height [cm]", limits = c( 130, 200 ), breaks = c( 130, 135, 150, 175, 180 ) )
```
...
```{r}
ggplot( pulse, aes( x = weight, y = height ) ) +
  geom_point( aes( color = age, shape = gender ), size = 3, alpha = 0.8 ) +
  scale_y_continuous( name = "Height [cm]", limits = c( 130, 200 ) ) +
