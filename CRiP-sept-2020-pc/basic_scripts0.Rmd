...
backtick <- "`"
```
`r direct_exercise( paste0( "Follow the steps from the sections above to create a new R Markdown document ", backtick, "Lesson_2.Rmd", backtick, ". Be sure to work in the project ", backtick, "Learning_R", backtick, " where you copied the table file." ) )`
