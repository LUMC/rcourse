...
_Locate the header in the Figure below. Create a new R Markdown document and make it empty. Then write a header at the top based on the Figure below. Add your name as the author and change the title. Knit to see the effect._
...
_Locate two chunks in the Figure below. Based on the Figure, in your R Markdown document type a new chunk. Put an R expression into the chunk. Knit to see the effect._
